        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 sm:p-7 flex flex-col md:flex-row md:items-center justify-between gap-5">
            <div class="space-y-1.5 max-w-2xl">
                <div class="flex items-center gap-2 flex-wrap">
                    ...
                    <span class="text-slate-300">&bull;</span>
                    <a href="{{ route('asesor.pendaftaran.ak07.edit', $pendaftaran->id) }}" target="_blank" class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs font-bold transition shadow-2xs" title="Buka Formulir Penyesuaian Asesmen (FR.AK.07)">
