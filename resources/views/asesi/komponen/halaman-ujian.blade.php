...
<div id="ruangUjianApp" 
    ...
    <!-- =========================================================================
         WORKSPACE RESMI RUANG UJIAN (AKTIF / READONLY REVIEW)
         ========================================================================= -->
    <!-- HEADER KONTROL UJIAN (COMPACT & MODERN) -->
        <div class="bg-white rounded-2xl border border-slate-200/90 shadow-xs overflow-hidden">
            <!-- Top Bar: Status, Autosave, Timer, Submit Action -->
            <div class="px-5 py-3.5 bg-slate-50/80 border-b border-slate-100 flex flex-wrap items-center justify-between gap-3 text-xs">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    @else
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-100 text-slate-700 border border-slate-200 text-[11px] font-bold">
                ...
                <!-- Right Controls: Autosave + Timer + Submit -->
                <div class="flex items-center gap-2.5 ml-auto">
                    @if(!$isReadonly)
                        ...
                        @if(($statusSesi['status'] ?? '') === 'aktif')
                            <div class="inline-flex items-center gap-2 px-3.5 py-1 rounded-xl bg-slate-900 text-white shadow-xs border border-slate-800">
            ...
            <!-- Single Row Strip Metadata (Compact & Sleek) -->
            ...
            <div class="px-5 py-2.5 bg-slate-50/50">
                <div class="inline-flex p-1 bg-slate-100 rounded-xl border border-slate-200/80 gap-1 overflow-x-auto max-w-full text-xs">
                    @if(!empty($soalCbt))
                        <button type="button" 
                                @click="activeTab = 'cbt'"
                                class="px-3.5 py-1.5 rounded-lg font-semibold transition flex items-center gap-2 shrink-0 cursor-pointer"
        ...
        <!-- =========================================================================
             TAB 1: FR.IA.05 CBT PILIHAN GANDA
             ========================================================================= -->
        @if(!empty($soalCbt))
